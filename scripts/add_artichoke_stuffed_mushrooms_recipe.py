#!/usr/bin/env python3
"""
Script to create the Artichoke-Stuffed Mushrooms recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Artichoke-Stuffed Mushrooms Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Artichoke-Stuffed Mushrooms", False, 4, serving_unit_id))
        
        recipe_id = cursor.lastrowid
        print(f"\n  ✓ Created recipe (ID: {recipe_id})")
        
        items = [
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Frozen Artichoke Hearts", cursor), "quantity": 1, "unit_id": package_unit_id, "size_qualifier": None, "preparation_notes": "10 oz"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("White Mushrooms", cursor), "quantity": 8, "unit_id": ounce_unit_id, "size_qualifier": None, "preparation_notes": None},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Scallions", cursor), "quantity": 2, "unit_id": tablespoon_unit_id, "size_qualifier": None, "preparation_notes": "chopped, green and white parts"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Ground Flaxseeds", cursor), "quantity": 1, "unit_id": tablespoon_unit_id, "size_qualifier": None, "preparation_notes": None},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Fresh Thyme", cursor), "quantity": 0.5, "unit_id": teaspoon_unit_id, "size_qualifier": None, "preparation_notes": "minced"},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Whole-Grain Bread Crumbs", cursor), "quantity": 0.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": None},
        ]
