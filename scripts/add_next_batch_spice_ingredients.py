#!/usr/bin/env python3
"""
Script to add spice ingredients for next batch recipes:
1. Red Pepper Flakes
2. Chipotle Chile Powder
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Adding Spice Ingredients for Next Batch Recipes")
        print("=" * 60)
        
        # Step 1: Add Red Pepper Flakes
        print("\n--- Step 1: Adding Red Pepper Flakes ---")
        ...
        # Step 2: Add Chipotle Chile Powder
        print("\n--- Step 2: Adding Chipotle Chile Powder ---")
        create_ingredient_with_conversions(
