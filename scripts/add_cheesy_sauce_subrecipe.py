#!/usr/bin/env python3
"""
Script to create the Cheesy Sauce sub-recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Cheesy Sauce Sub-Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Cheesy Sauce", True, 1, cup_unit_id))
        ...
        items = [
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Rice Vinegar", cursor), "quantity": 1, "unit_id": teaspoon_unit_id, "size_qualifier": None, "preparation_notes": None},
