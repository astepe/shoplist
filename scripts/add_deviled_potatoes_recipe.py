#!/usr/bin/env python3
"""
Script to create the Deviled Potatoes recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Deviled Potatoes Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Deviled Potatoes", False, 6, serving_unit_id))
        
        recipe_id = cursor.lastrowid
        print(f"\n  ✓ Created recipe (ID: {recipe_id})")
        
        items = [
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Small Potatoes", cursor), "quantity": 12, "unit_id": whole_unit_id, "size_qualifier": None, "preparation_notes": "small white or Yukon Gold"},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Apple Cider Vinegar", cursor), "quantity": 1.5, "unit_id": teaspoon_unit_id, "size_qualifier": None, "preparation_notes": None},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Unsweetened Soy Milk", cursor), "quantity": 1, "unit_id": tablespoon_unit_id, "size_qualifier": None, "preparation_notes": "if needed, 1 tablespoon at a time"},
        ]
