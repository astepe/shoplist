#!/usr/bin/env python3
"""
Script to create the Balsamic Syrup recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Balsamic Syrup Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Balsamic Syrup", True, 0.5, cup_unit_id))
        ...
        items = [
            # 1. 1 cup balsamic vinegar
            {
                ...
                "ingredient_id": get_ingredient_id("Balsamic Vinegar", cursor),
                "quantity": 1,
                "unit_id": cup_unit_id,
                "size_qualifier": None,
