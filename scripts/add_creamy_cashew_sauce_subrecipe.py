#!/usr/bin/env python3
"""
Script to create the Creamy Cashew Sauce sub-recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Creamy Cashew Sauce Sub-Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Creamy Cashew Sauce", True, 2, cup_unit_id))
        
        recipe_id = cursor.lastrowid
        print(f"\n  ✓ Created sub-recipe (ID: {recipe_id})")
        
        items = [
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Raw Cashews", cursor), "quantity": 1.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "150g"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Unsweetened Soy Milk", cursor), "quantity": 1, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "235ml"},
            {"item_type": "sub_recipe", "sub_recipe_id": roasted_garlic_id, "quantity": 1, "unit_id": tablespoon_unit_id, "size_qualifier": None, "preparation_notes": "or 2 garlic cloves, chopped"},
