#!/usr/bin/env python3
"""
Script to create the Tomato Salsa sub-recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Tomato Salsa Sub-Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Tomato Salsa", True, 4, serving_unit_id))
        
        recipe_id = cursor.lastrowid
        print(f"\n  ✓ Created sub-recipe (ID: {recipe_id})")
        
        items = [
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Ripe Tomatoes", cursor), "quantity": 5, "unit_id": whole_unit_id, "size_qualifier": None, "preparation_notes": "firm plum tomatoes, coarsely chopped"},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Jalapeño", cursor), "quantity": 1, "unit_id": whole_unit_id, "size_qualifier": None, "preparation_notes": "or another small hot chile, seeded and minced, optional"},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Fresh Cilantro", cursor), "quantity": 2, "unit_id": tablespoon_unit_id, "size_qualifier": None, "preparation_notes": "minced fresh cilantro or parsley"},
