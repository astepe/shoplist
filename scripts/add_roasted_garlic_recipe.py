#!/usr/bin/env python3
"""
Script to create the Roasted Garlic recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Roasted Garlic Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Roasted Garlic", True, 0.25, cup_unit_id))
        ...
        # Add recipe items
        items = [
            # 1. 1 large whole head of garlic
            {
                ...
                "preparation_notes": "whole head of garlic"
            },
        ]
