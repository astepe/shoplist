#!/usr/bin/env python3
"""
Script to create the Lemony Spinach-Tahini Dip recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Lemony Spinach-Tahini Dip Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Lemony Spinach-Tahini Dip", False, 4, serving_unit_id))
        
        recipe_id = cursor.lastrowid
        print(f"\n  ✓ Created recipe (ID: {recipe_id})")
        
        items = [
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Fresh Baby Spinach", cursor), "quantity": 1, "unit_id": package_unit_id, "size_qualifier": None, "preparation_notes": "10 oz, 285g"},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Raw Sesame Seeds", cursor), "quantity": 1, "unit_id": teaspoon_unit_id, "size_qualifier": None, "preparation_notes": None},
        ]
