#!/usr/bin/env python3
"""
Script to create the Date Syrup 2.0 recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Date Syrup 2.0 Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Date Syrup 2.0", True, 1.5, cup_unit_id))
        ...
        items = [
            ...
            # 2. 1.5 cups boiling water, plus more as needed
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Water", cursor),
                "quantity": 1.5,
                "unit_id": cup_unit_id,
                "size_qualifier": None,
                "preparation_notes": "boiling water, plus more as needed"
            },
