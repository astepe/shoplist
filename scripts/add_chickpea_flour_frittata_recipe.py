#!/usr/bin/env python3
"""
Script to create the Chickpea Flour Vegetable Frittata recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Chickpea Flour Vegetable Frittata Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Chickpea Flour Vegetable Frittata", False, 4, serving_unit_id))
        
        recipe_id = cursor.lastrowid
        print(f"\n  ✓ Created recipe (ID: {recipe_id})")
        
        items = [
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("White Mushrooms", cursor), "quantity": 1, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "thinly sliced"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Red Bell Pepper", cursor), "quantity": 0.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "finely chopped"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Zucchini", cursor), "quantity": 0.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "finely chopped"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Red Onion", cursor), "quantity": 0.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "finely chopped"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Cherry Tomatoes", cursor), "quantity": 1, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "quartered"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Chickpea Flour", cursor), "quantity": 1, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "90g"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Water", cursor), "quantity": 1, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": None},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Aluminum- and Sodium-Free Baking Powder", cursor), "quantity": 1, "unit_id": teaspoon_unit_id, "size_qualifier": None, "preparation_notes": None},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Ground Fennel Seeds", cursor), "quantity": 0.5, "unit_id": teaspoon_unit_id, "size_qualifier": None, "preparation_notes": None},
