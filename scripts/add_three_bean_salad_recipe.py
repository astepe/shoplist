#!/usr/bin/env python3
"""
Script to create the Three-Bean Salad with Spicy Tomato Dressing recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Three-Bean Salad with Spicy Tomato Dressing Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Three-Bean Salad with Spicy Tomato Dressing", False, 8, serving_unit_id))
        ...
        items = [
            # For the SALAD:
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Salt-Free Pinto Beans", cursor), "quantity": 1.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "375g, home-cooked or from BPA-free cans or Tetra Paks, drained and rinsed"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Salt-Free Black Beans", cursor), "quantity": 1.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "375g, home-cooked or from BPA-free cans or Tetra Paks, drained and rinsed"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Salt-Free Red Kidney Beans", cursor), "quantity": 1.5, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "400g, home-cooked or from BPA-free cans or Tetra Paks, drained and rinsed"},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Fresh Cilantro", cursor), "quantity": 2, "unit_id": tablespoon_unit_id, "size_qualifier": None, "preparation_notes": "finely chopped"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Hass Avocado", cursor), "quantity": 1, "unit_id": whole_unit_id, "size_qualifier": None, "preparation_notes": "optional"},
            # For the DRESSING:
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Plum Tomatoes", cursor), "quantity": 3, "unit_id": whole_unit_id, "size_qualifier": None, "preparation_notes": "cored and halved"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Apple Cider Vinegar", cursor), "quantity": 2, "unit_id": tablespoon_unit_id, "size_qualifier": None, "preparation_notes": None},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Jalapeño", cursor), "quantity": 1, "unit_id": teaspoon_unit_id, "size_qualifier": None, "preparation_notes": "minced"},
