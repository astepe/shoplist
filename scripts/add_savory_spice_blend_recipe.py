#!/usr/bin/env python3
"""
Script to create the Savory Spice Blend 2.0 recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Savory Spice Blend 2.0 Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Savory Spice Blend 2.0", True, 0.5, cup_unit_id))
        ...
        items = [
            ...
            # 2. 1 tablespoon onion powder or granules
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Onion Powder", cursor),
                "quantity": 1,
                "unit_id": tablespoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": "powder or granules"
            },
            # 3. 2 teaspoons garlic powder or granules
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Garlic Powder", cursor),
                "quantity": 2,
            ...
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Ground Paprika", cursor),
                "quantity": 2,
                "unit_id": teaspoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": None
            },
            # 5. 1 teaspoon ground black cumin (nigella seeds)
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Ground Black Cumin (Nigella Seeds)", cursor),
                "quantity": 1,
                "unit_id": teaspoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": None
            },
            # 6. 0.5 teaspoon ground ginger
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Ground Ginger", cursor),
                "quantity": 0.5,
                "unit_id": teaspoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": None
            },
            # 7. 0.5 teaspoon ground thyme
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Ground Thyme", cursor),
                "quantity": 0.5,
                "unit_id": teaspoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": None
            },
            # 8. 0.5 teaspoon mustard powder
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Mustard Powder", cursor),
                "quantity": 0.5,
                "unit_id": teaspoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": None
            },
            # 9. 0.5 teaspoon ground turmeric
            {
                "item_type": "ingredient",
            ...
            # 10. 0.5 teaspoon celery seeds
            {
                "item_type": "ingredient",
                "ingredient_id": get_ingredient_id("Celery Seeds", cursor),
                "quantity": 0.5,
                "unit_id": teaspoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": None
            },
            # 11. 0.5 teaspoon ground pippali or black pepper
            {
                "item_type": "ingredient",
                ...
                "unit_id": teaspoon_unit_id,
                "size_qualifier": None,
                "preparation_notes": "ground pippali or black pepper"
            },
        ]
