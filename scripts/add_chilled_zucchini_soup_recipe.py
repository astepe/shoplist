#!/usr/bin/env python3
"""
Script to create the Chilled Zucchini Soup recipe.
"""
...
def main():
    ...
    try:
        print("=" * 60)
        print("Creating Chilled Zucchini Soup Recipe")
        print("=" * 60)
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?)
        """, ("Chilled Zucchini Soup", False, 6, serving_unit_id))
        ...
        items = [
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Zucchini", cursor), "quantity": 1.5, "unit_id": pound_unit_id, "size_qualifier": None, "preparation_notes": "680g, chopped"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Fennel Bulb", cursor), "quantity": 1, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "90g, chopped"},
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Garlic", cursor), "quantity": 3, "unit_id": clove_unit_id, "size_qualifier": "medium", "preparation_notes": "minced"},
            ...
            {"item_type": "ingredient", "ingredient_id": get_ingredient_id("Unsweetened Soy Milk", cursor), "quantity": 1, "unit_id": cup_unit_id, "size_qualifier": None, "preparation_notes": "235ml, or as desired"},
        ]
